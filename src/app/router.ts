...
export const PANEL_ADD_MEMBERS_ID = 'panel_add_members_id';
export const PANEL_LIST_MEMBERS_ID = 'panel_list_members_id';
...
export const PAGE_ADD_MEMBERS_ID = '/collection/add-members/:collectionId([0-9a-zA-Z-]+)';
export const PAGE_LIST_MEMBERS_ID = '/collection/list-members/:collectionId([0-9a-zA-Z-]+)';
...
const routes = {
    ...
    [PAGE_ADD_MEMBERS_ID]: new Page(PANEL_ADD_MEMBERS_ID, VIEW_CREATE),
    [PAGE_LIST_MEMBERS_ID]: new Page(PANEL_LIST_MEMBERS_ID, VIEW_CREATE),
