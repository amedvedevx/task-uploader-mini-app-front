import type { GetTasksResponce, GetTaskIdResponce, GetTaskResultsResponce } from '../../src/app/types';

const ApiBaseUrl = `https://${Cypress.env('API_BASE_URL')}`;

export const interceptTaskId = (bodyData: GetTaskIdResponce): GetTaskIdResponce =>
    cy.intercept('GET', `${ApiBaseUrl}/task/08ef58ee-18e4-452d-ac23-f9482c5d2bef`, { body: bodyData }).as('getTaskId');
...
export const interceptDeleteTaskId = (bodyData: GetTasksResponce): void =>
    ...
    cy
        .intercept('GET', `${ApiBaseUrl}/collectionId/08ef58ee-18e4-452d-ac23-f9482c5d2bef`, { body: bodyData })
        .as('taskIdResults');
